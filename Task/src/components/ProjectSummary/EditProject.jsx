...
import { createProjectApi, getProjectApi, update_ProjectApi } from '../../utils/projects';
import { toast } from 'react-toastify';
import { jwtDecode } from "jwt-decode"
import { getAllUsersApi } from '../../utils/auth';

const EditProject = ({ closeModal, handleClick, getProjectApi,project }) => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const result = await update_ProjectApi(payload,project.id);
